...
class Dataset_divvy_hour(Dataset):
    ...
    def __read_data__(self):
        ...
        print ("border1, border2, self.features, self.scale, self.timeenc,self.set_type : ",
        border1s, border2s, self.features, self.scale, self.timeenc,self.set_type,border1,border2 )
...
''' Daily dataset for M5 competition; wallmart sales data '''
class Dataset_M5_daily(Dataset):
    def __init__(self, root_path, flag='train', size=None,
                 features='S', data_path='M5_sales.csv',
                 target='OT', scale=True, timeenc=0, freq='h', seasonal_patterns=None ):
        # size [seq_len, label_len, pred_len]                                                                                                                                                                                                                                                               
        # info                                                                                                                                                                                                                                                                                              
        if size == None:
    ...
    def __read_data__(self):
        ...
        border1s = [0,         2*365 - self.seq_len,    2*365 + 6*30 - self.seq_len]
        border2s = [2*365,   2*365 + 6*30,          2*365 + 12*30 ]
        border1 = border1s[self.set_type]
        border2 = border2s[self.set_type]
